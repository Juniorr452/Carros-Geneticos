// From https://gist.github.com/MichaelProkofyev/ef4cb0612730fd516058e40d37b2229a
using UnityEngine;
...
public class CurvedText : BaseMeshEffect
{
	...
	public void ModifyVertices (List<UIVertex> verts)
	{
			...
			for (int index = 0; index < verts.Count; index++) {
					...
					//Debug.Log ();
					uiVertex.position.z += curveForText.Evaluate (rectTrans.rect.width * rectTrans.pivot.x + uiVertex.position.x) * curveMultiplier;
